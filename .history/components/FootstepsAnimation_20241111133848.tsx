...
const FootstepsAnimation: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const flowingPath = [
      ...
      { x: 100, y: 100 },    // Starting at first circle (moved left)
      { x: 150, y: 95 },     // Gentle curve up
      { x: 200, y: 90 },     // Peak
      { x: 250, y: 95 },     // Coming down
      { x: 300, y: 100 },    // Level out
      
      // To second circle (Business Leadership)
      { x: 350, y: 95 },     // Start rise
      { x: 400, y: 90 },     // Peak
      { x: 450, y: 95 },     // Coming down
      { x: 500, y: 100 },    // Second circle position
      
      // To third circle (Tech Innovation)
      { x: 550, y: 95 },     // Start final rise
      { x: 600, y: 90 },     // Peak
      { x: 650, y: 95 },     // Coming down
      { x: 700, y: 100 },    // Final circle position
      { x: 650, y: 95 },     // Start final rise
      { x: 700, y: 90 },     // Peak
      { x: 750, y: 95 },     // Coming down
      { x: 800, y: 100 },    // Final circle position
    ];
