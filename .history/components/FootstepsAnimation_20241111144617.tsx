...
const FootstepsAnimation: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Swap the isLeft boolean for vertical path to reverse positions
    animateFootstep(leftFootRef.current, verticalPath, horizontalDuration, false, true);  // Changed isLeft to false
    animateFootstep(rightFootRef.current, verticalPath, horizontalDuration + 0.35, true, true);  // Changed isLeft to true
