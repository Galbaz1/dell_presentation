...
const FootstepsAnimation: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const flowingPath = [
      ...
      { x: 200, y: 100 },    // Starting at first circle
      { x: 250, y: 95 },     // Gentle curve up
      { x: 300, y: 90 },     // Peak
      { x: 350, y: 95 },     // Coming down
      { x: 400, y: 100 },    // Level out
      
      // To second circle (Business Leadership)
      { x: 450, y: 95 },     // Start rise
      { x: 500, y: 90 },     // Peak
      { x: 550, y: 95 },     // Coming down
      { x: 600, y: 100 },    // Second circle position
