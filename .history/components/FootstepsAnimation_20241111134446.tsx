...
const RightFootprint = React.forwardRef<SVGSVGElement>((_, ref) => (
  <svg 
    ...
    style={{ transform: 'rotate(90deg)', color: '#b45309' }}
  >
...
const FootstepsAnimation: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const flowingPath = [
      ...
      { x: 380, y: 95 },     // Gentle curve up
      { x: 480, y: 90 },     // Peak
      { x: 580, y: 95 },     // Coming down
      { x: 680, y: 100 },    // Second circle position
      
      // To third circle (Tech Innovation)
      { x: 780, y: 95 },     // Start final rise
      { x: 880, y: 90 },     // Peak
      { x: 980, y: 95 },     // Coming down
      { x: 1080, y: 100 },   // Third circle position
      { x: 1180, y: 95 },    // Extra point past third circle
      { x: 1280, y: 90 },    // Final position
    ];
