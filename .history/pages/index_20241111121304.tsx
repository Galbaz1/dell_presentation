  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-8 rounded-xl shadow-lg min-h-screen overflow-hidden">
      ...
      <div className="relative max-w-[1200px] mx-auto mt-24">
        <div className="flex justify-between items-center synergy-animation px-16 relative">
          {/* AI Engineering Role */}
          ...
          {/* Synergy Arrows */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 synergy-animation z-10">
