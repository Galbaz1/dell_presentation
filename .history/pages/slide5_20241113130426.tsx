  ...
  const solutions = [
    {
      ...
      description: "Backwards compatibility with existing systems",
      items: [
    ...
    },
    {
      ...
      description: "Understand what's happening under the hood",
      items: [
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 p-8 rounded-xl shadow-lg min-h-screen overflow-hidden relative">
      ...
      >
        ...
        >
          <h1 className="text-4xl font-bold text-emerald-900">Challenges</h1>
        </motion.div>
        <p className="text-xl text-emerald-700 flex items-center justify-center">
          <Trophy className="w-6 h-6 mr-2" />
          Choose a challenge to explore and collaborate on solutions
        </p>
      </motion.div>
