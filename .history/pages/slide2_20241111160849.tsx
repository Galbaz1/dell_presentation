...
import { ArrowRight, ArrowLeft, AlertCircle, Brain } from 'lucide-react';
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-8 rounded-xl shadow-lg min-h-screen overflow-hidden relative">
      ...
      <div className="max-w-5xl mx-auto relative h-[500px]">
        ...
        {/* Falling Block */}
        <div 
          className="absolute left-1/2 -translate-x-1/2 top-0 w-[300px] animate-fall-bounce"
        >
        ...
        {/* Developer Figure */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 animate-developer-fall origin-bottom">
