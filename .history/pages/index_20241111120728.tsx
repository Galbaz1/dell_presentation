  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-8 rounded-xl shadow-lg min-h-screen overflow-hidden">
      ...
      <div className="relative mb-16">
        {/* Connecting Lines */}
        <svg className="absolute top-1/2 left-0 w-full h-1" style={{ transform: 'translateY(-50%)' }}>
          <path 
            d="M100 0 L400 0" 
            className="footsteps-path footsteps-animation-1"
            stroke="#fcd34d" 
            strokeWidth="4"
            fill="none"
            strokeDasharray="10"
          ...
          <path 
            d="M500 0 L800 0" 
            className="footsteps-path footsteps-animation-2"
            stroke="#fcd34d" 
            strokeWidth="4"
            fill="none"
            strokeDasharray="10"
        ...
        <div className="relative flex justify-between items-center">
          {/* Academic Foundation */}
          <div className="w-64 relative fall-animation">
          ...
          {/* Business Experience */}
          <div className="w-64 relative fall-animation fall-animation-delay-1">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
              <div className="w-6 h-6 rounded-full bg-amber-400 border-4 border-amber-600" />
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md mt-6">
          ...
          {/* Tech Innovation */}
          <div className="w-64 relative fall-animation fall-animation-delay-2">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
              <div className="w-6 h-6 rounded-full bg-amber-400 border-4 border-amber-600" />
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md mt-6">
      ...
      <div className="relative max-w-2xl mx-auto mt-20">
        <div className="flex justify-between items-center synergy-animation">
          {/* AI Engineering Role */}
        ...
        {/* Synergy Arrows */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 synergy-animation">
